...
INSTALLED_APPS = [
    ...
    'django_bootstrap5', 'django_mptt_admin', 'mptt', 'online_users',

    'base.apps.BaseConfig', 'exploitation.apps.ExploitationConfig', 'build.apps.BuildConfig',
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'helpdeslV3.sqlite3',
    }
}
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static", 'F:/Projects/djangoprojects/helpdesk_V3/static/']
# Default primary key field type
# https://docs.djangoproject.com/en/4.1/ref/settings/#default-auto-field

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

ProjectName = "АРМ Эаявки"
